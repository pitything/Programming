...
public class _5_快速排序 {
   ...
   */
    public static void quickSort(int[] arr, int left, int right) {
        ...
        int pivot = arr[mid];
        while (mid < r) {
            // mid<r，防止数组越界，找到右边小于 pivot的值的位置，放到左边
            while (mid < r && pivot <= arr[r]) r--;
            //如果值小于 key分界值 交换
            arr[mid] = arr[r];
            // 找到左边大于 pivot的值的位置，放到右边
  ...
  private static int[] quickSort3(int[] array){
        ...
        while (!stack.isEmpty()) {
            ...
            int pivot = array[mid];
            while(mid < r){
                while(mid < r && pivot <= array[r]) r--;
                array[mid] = array[r];
                while(mid < r && pivot >= array[mid]) mid++;
                array[r] = array[mid];
            }
            array[mid] = pivot;
...
<img src="https://raw.githubusercontent.com/pitything/images/main/https://cdn.jsdelivr.net/gh/pitything/images@master/image-20220725164249251.png" alt="image-20220725164249251" style="zoom:25%;" />![image-20220801154647330](https://raw.githubusercontent.com/pitything/images/main/https://cdn.jsdelivr.net/gh/pitything/images@master/image-20220801154647330.png)

##### 上溢的RR插入情况

> 父节点存在兄弟节点，父节点为祖父节点的右节点，插入节点为父节点的右节点。并且构成的新的B树节点已经超过了B树节点容量大小范围。

![image-20220801154647330](https://raw.githubusercontent.com/pitything/images/main/https://cdn.jsdelivr.net/gh/pitything/images@master/image-20220801154647330.png)
...
>
> <img src="https://raw.githubusercontent.com/pitything/images/main/https://cdn.jsdelivr.net/gh/pitything/images@master/image-20220801154741847.png" alt="image-20220801154741847" style="zoom:50%;" />
>
> 对上图的说明:
>
