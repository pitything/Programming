...
public class SendSMSUtil {
    ...
    // 替换成你的AK
    private static final String accessKeyId = "LTAI5tMQW7P6jA1YtuMGcrwT";// 你的accessKeyId
    private static final String accessKeySecret = "OCmNs9JlOSHC3qUfLD35v786xQOWjf";// 你的accessKeySecret
