...
@WebFilter(urlPatterns = {"*.do","*.html"},
        initParams = {
            @WebInitParam(name = "bai",
                    ...
                    value = "/page.do?operate=page&page=user/login,/page.do?operate=page&page=user/regist," +
                            "/user.do?null")
        })
public class SessionFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        // if(str.equals("/page.do?operate=page&page=redirect:hello02") || str.equals("/hello02.html?null")){
        ...
        if(baiList.contains(str)){
            ...
            if("/regist.html?null".equals(str)){
                response.sendRedirect("page.do?operate=page&page=user/regist");
            }
